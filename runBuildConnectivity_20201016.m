...
sConnParams.vecConductance_FromLGN_ToCort = (1/(64*dblScaleCorrection))*[1.1 1.28]*0.24; %to [pyramid interneuron]
...
%conductances
sConnParams.matConductancesFromTo(1,:) = (0.01*[0.96 1.28])/dblScalingFactor; %from pyramid to [pyr inter]
sConnParams.matConductancesFromTo(2,:) = (0.01*[1.50 1.00])/dblScalingFactor; %from inter to [pyr inter]
