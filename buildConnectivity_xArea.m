function sConnectivity = buildConnectivity_xArea(sConnParams)
	...
	for intNeuron=1:intCellsV1
		...
		for intSubIdx=1:length(vecCellTypeLabels)
			...
			vecSynV1Weight(vecConnsAssign) = vecConnProb(vecConns)./(mean(vecConnProb(vecConns)));
	...
	drawnow;pause;
		...
		for intCellV2=1:intCellsV2
			...
			for intSubIdx=1:length(vecCellTypeLabels)
				...
				vecSynV2Weight(vecConnsAssign) = vecTheseWeights;
