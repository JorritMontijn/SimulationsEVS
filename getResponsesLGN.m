function [matLGN_ON,matLGN_OFF,varDeltaSyn] = getResponsesLGN(matR_ON,matR_OFF,sParams)
	...
	if ~isfield(sParams,'dblLGN_baseline'),dblLGN_baseline = 15;else dblLGN_baseline=sParams.dblLGN_baseline;end
	...
	dblNewMax = dblLGN_baseline + 25*max(0,log10(dblLuminance));
